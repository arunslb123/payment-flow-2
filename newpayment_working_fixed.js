...
jQuery( document ).ready(function($) {
  ...
  var ListView = Backbone.View.extend({
    el: jQuery('.container'),
    events: {
      'click #emailbutton': 'addItem',
      'click #couponcheck2': 'displayCoupon'
    },
    initialize: function(){
      _.bindAll(this, 'addItem', 'addPassword','setPasswords','validateEmail','displayCoupon','addProductDetails'); // remember: every function that uses 'this' as the current object should be in here
...
//     initialize: function(){
//             var self=this;
//       _.bindAll(this,'render','addProductDetails'); // remember: every function that uses 'this' as the current object should be in here
